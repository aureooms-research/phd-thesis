...
\(d=1\), this problem is Element Uniqueness. Finding the location of each point
...
whether any of this classification was any good. Sure, many problems involve
sorting, and therefore, according to this dubious definition, are
``generalizations'' of it.

However, the author begs to differ.

Explain 2D-2SUM, 2D-3POL, 2D-2POL, 3POL and cite paper B.

Turns out 2D-3POL generalizes GPT, 2D-2POL is a subroutine of our 3POL
algorithm.
