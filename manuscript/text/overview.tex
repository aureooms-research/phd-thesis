...
\paragraph{Sorting}
The archetypal computation tree problem is the Sorting problem.
It is one of the oldest and most practical data management problems.
%
...
It is easy to see that Element Uniqueness is equivalent to the 2SUM problem,
and that Sorting amounts to locating the point \(q\) in the arrangement of
hyperplanes of equations \(x_i - x_j = 0\).
...
matters here, the Sorting problem is solved.
