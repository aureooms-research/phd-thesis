...
\subsection{Representation by numbers} \label{s:numbers}
...
\subsection{Space-optimal representation} \label{s:space}
...
\section{Recycling Gr\o nlund and Pettie's Algorithm}



\subsection{Subquadratic space and constant query time}\label{s:sscqt}
