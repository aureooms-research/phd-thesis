...
\aurelien{Can't we just have \(n^{d-2}\) times the \(2d\) encoding?}

\aurelien{Can't seem to make induction work for orientation. Works on point location though.}
...
%
\input{text/paper/order-type-encoding/text/theorem/realizable-d}
\input{text/paper/order-type-encoding/text/theorem/preprocessing-d}
...
\input{text/paper/order-type-encoding/text/theorem/intersection-d}
