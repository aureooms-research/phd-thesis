...
%\item[output] The location \(\sigma(H,q)\) for all \(H \in \mathcal{H}\).
...
Hence, the query complexity of step \step{1} is $O(n^2 \log n)$, and that of step
...
the complexity bottleneck of the algorithm are steps \step{3}-\step{4},
